...
const DESIGN_SOURCES: readonly DesignSource[] = [
  ...
  },
  {
    ...
    needs: ['primitive', 'application'],
    stacks: ['react', 'next'],
    tags: ['accessible', 'headless', 'keyboard', 'focus', 'internationalization', 'collections', 'hooks'],
    authority: 'library',
    integration: 'react-aria / react-aria-components with current Adobe docs',
    license: 'Apache-2.0',
    dependencyNote: 'Deep accessibility and internationalization behavior; best when complex interaction correctness matters.',
    adapt: 'Use the interaction/accessibility model and own the product styling rather than recreating keyboard behavior.',
  },
  {
    id: 'headless-ui',
    name: 'Headless UI',
    needs: ['primitive', 'application'],
    stacks: ['react', 'vue', 'tailwind'],
    tags: ['accessible', 'headless', 'dialog', 'menu', 'listbox', 'combobox', 'tailwind'],
    authority: 'library',
    integration: 'Official React/Vue packages and docs',
    license: 'MIT',
    dependencyNote: 'Focused unstyled behavior primitives with especially natural Tailwind integration.',
    adapt: 'Keep its semantics/interaction and make the visual layer match the existing design contract.',
  },
  {
    id: 'primer',
    name: 'Primer',
  ...
  },
  {
    ...
    needs: ['application', 'data'],
    stacks: ['react'],
    tags: ['adobe', 'accessible', 'internationalization', 'enterprise', 'forms', 'collections'],
    authority: 'official-system',
    integration: '@adobe/react-spectrum and current Adobe documentation',
    license: 'Apache-2.0',
    dependencyNote: 'A complete Adobe design language layered over the same accessibility foundations as React Aria.',
    adapt: 'Adopt when Spectrum itself fits the product; otherwise prefer React Aria for behavior without the visual language.',
  },
  {
    id: 'mui',
    name: 'Material UI',
    needs: ['application', 'data'],
    stacks: ['react', 'next'],
    tags: ['material', 'enterprise', 'forms', 'tables', 'data-grid', 'theming', 'components'],
    authority: 'official-system',
    integration: '@mui/material / official MUI docs',
    license: 'MIT for MUI Core; verify MUI X tier/licence before using advanced X components',
    dependencyNote: 'Large mature ecosystem; data-heavy screens may involve separate MUI X packages and licensing tiers.',
    adapt: 'Use the theme deliberately if adopting Material; do not mix Material defaults into a non-Material product by accident.',
  },
  {
    id: 'chakra-ui',
    name: 'Chakra UI',
    needs: ['application'],
    stacks: ['react', 'next'],
    tags: ['accessible', 'styled', 'recipes', 'tokens', 'forms', 'components'],
    authority: 'official-system',
    integration: '@chakra-ui/react / official docs',
    license: 'MIT',
    dependencyNote: 'Broad styled component system with its own token/recipe model.',
    adapt: 'Prefer its system consistently once adopted; avoid stacking another styling abstraction on top.',
  },
  {
    id: 'mantine',
    name: 'Mantine',
    needs: ['application', 'data'],
    stacks: ['react', 'next'],
    tags: ['forms', 'hooks', 'dates', 'modals', 'data', 'components', 'theming'],
    authority: 'official-system',
    integration: '@mantine/core and related official packages/docs',
    license: 'MIT',
    dependencyNote: 'Batteries-included React ecosystem; useful when the product needs many application primitives quickly.',
    adapt: 'Use its theme and packages selectively; do not import broad feature packages for one tiny control.',
  },
  {
    id: 'fluent-ui',
    name: 'Fluent UI',
    needs: ['application', 'data'],
    stacks: ['react'],
    tags: ['microsoft', 'enterprise', 'office', 'accessibility', 'forms', 'tables', 'tokens'],
    authority: 'official-system',
    integration: '@fluentui/react-components / official Fluent docs',
    license: 'MIT',
    dependencyNote: 'Full Microsoft product language with strong enterprise/application coverage.',
    adapt: 'Use when Fluent is an intentional product-language choice; otherwise borrow interaction patterns, not Office identity.',
  },
  {
    id: 'ant-design',
    name: 'Ant Design',
    needs: ['application', 'data'],
    stacks: ['react'],
    tags: ['enterprise', 'admin', 'tables', 'forms', 'charts', 'data', 'components'],
    authority: 'official-system',
    integration: 'antd / official Ant Design docs',
    license: 'MIT',
    dependencyNote: 'Very broad application component surface; particularly strong for dense admin and data workflows.',
    adapt: 'Adopt its system coherently or use it as pattern research; mixing isolated Ant defaults into another system is visually obvious.',
  },
  {
    id: 'park-ui',
    name: 'Park UI',
